...
class WBK_Business_Hours {
	...
	protected $sunday_business_hours;
	// workday monday
	protected $monday_workday;
	// workday tuesday
	protected $tuesday_workday;
	// workday wednesday
	protected $wednesday_workday;
	// workday thursday
	protected $thursday_workday;
	// workday friday
	protected $friday_workday;
	// workday saturday
	protected $saturday_workday;
	
	// workday sunday
	protected $sunday_workday;
