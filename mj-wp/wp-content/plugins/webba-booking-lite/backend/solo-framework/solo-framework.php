...
function slfLoadAssets(){
	if ( isset( $_GET[ 'page' ] ) && ( $_GET[ 'page' ] == 'wbk-appearance'   ||   $_GET[ 'page' ] == 'wbk-appointments' || $_GET[ 'page' ] == 'wbk-email-templates' ) ) { 
...
class SoloFramework extends stdClass  {
	...
	public function renderSectionSetControls( $slug ){
		...
		//	$presets_folder = __DIR__ . DIRECTORY_SEPARATOR . 'presets' . DIRECTORY_SEPARATOR . 'section_sets' . DIRECTORY_SEPARATOR . $slug . DIRECTORY_SEPARATOR .'*';
		$presets_folder = dirname(__FILE__) . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . '..'.DIRECTORY_SEPARATOR .'presets'.DIRECTORY_SEPARATOR.'*';
